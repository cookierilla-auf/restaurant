...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'You cannot leave the name blank. The name field is required.',
            'name.filled' => 'You cannot leave the name blank. The name field is required.',
            'name.string' => 'The name must be a string.',
            'name.max' => 'The name must not exceed 255 characters.',
            'name.min' => 'You cannot leave the name blank. The name field is required.',
